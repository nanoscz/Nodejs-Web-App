...
exports.findProduct = function(args, callback){
    ...
    var query = productModel.find({ kupuvac: args});
...
exports.findOne = function( arg, callback){
    productModel.findOne({ _id: arg }, 'name prodavnica cena date', function (err, product) {
...
exports.findSimilar = function(args, callback){
    ...
    var query = productModel.find({ name: args['name'] });
...
exports.deleteProduct = function(args, newsCallback){
    productModel.remove({ _id: args }, function (err, numberRemoved) {
        if (err) throw(err);
...
exports.deleteAll = function(args){
    ...
    productModel.remove({ kupuvac: args['username'] }, function(err,numberRemoved) {
        if (err) throw(err);
